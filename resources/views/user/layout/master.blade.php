...
<li class="nav-item"><a class="nav-link" itemprop="url" href="https://www.totalassignmenthelp.com/free-sample/zara-case-study" title="ZARA Case Study"><span itemprop="name">Proof Reading Services UK</span></a></li>
    ...
    <li><input type="email" class="form-control" name="email" placeholder="Email" required></li>
    <li><input type="email" class="form-control" name="subject" placeholder="Subject" required></li>
    ...
    <select></li>
    <li><input type="datetime-local" class="deadline_time" id="deadline" name="deadline" style="border:1px solid #C0C0C0;"></li>
    <li style="float:right;"><button type="submit" class="get_assist" style="background-color:#4682B4;border:2px solid #4682B4;">Get Help</button></li>
